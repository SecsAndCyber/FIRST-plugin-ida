...
from ghidra.framework.plugintool.util import PluginStatus
...
if __name__ == "__main__":
    myPlugin = MyPlugin()
    pass # frame = FIRST_FormClass("Jython Example JButton")
